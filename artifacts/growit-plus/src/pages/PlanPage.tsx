...
import { Printer, RotateCcw, AlertTriangle, MapPin, Calendar, Info, Sparkles, Cpu } from "lucide-react";
      ...
      <div className="px-6 pt-10 pb-4 bg-gradient-to-b from-cream-dark/30 to-cream shrink-0">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          {plan.generationMode === "ai" ? (
            <div className="flex items-center gap-1 bg-forest text-cream border border-forest/20 px-3 py-1 rounded-full text-xs font-semibold" title="Plant selection and growing advice generated by AI">
              <Sparkles className="w-3 h-3" />
              AI-Enhanced
            </div>
          ) : plan.fallbackReason ? (
            <div className="flex items-center gap-1 bg-cream-dark border border-cream-dark px-3 py-1 rounded-full text-xs font-medium text-forest/60" title={plan.fallbackReason}>
